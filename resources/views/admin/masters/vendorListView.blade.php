<x-admin.layout>
    <x-slot name="title">Vendor List View Details</x-slot>
    <x-slot name="heading">Vendor List View Details</x-slot>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex flex-wrap align-items-start gap-2">
                                                ...
                                                <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add New Vendor</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="gst_no">GST NO</th>
                                                        <th class="sort" data-sort="contact_person">Contact Person</th>
                                                        <th class="sort" data-sort="phone">Phone</th>
                                                        <th class="sort" data-sort="email">Email</th>
                                                        <th class="sort" data-sort="status">Status</th>
                                                        <th class="sort" data-sort="state">State</th>
                                                        <th class="sort" data-sort="tds">TDS</th>
                                                        <th class="sort" data-sort="vech_total">Vech Total</th>
                                                ...
                                                <form class="tablelist-form" autocomplete="off">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" id="phone-field" class="form-control" placeholder="Enter phone no." required />
