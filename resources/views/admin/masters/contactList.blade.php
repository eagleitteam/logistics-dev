<x-admin.layout>
    <x-slot name="title">Contact List View</x-slot>
    <x-slot name="heading">Contact List View</x-slot>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (!data.error2)
                    ...
                    .then((action) => {
                        window.location.href = '{{ route('Contact-List.index') }}';
                    });
                else
...
<script>
    $("#buttons-datatables").on("click", ".edit-element", function(e) {
        ...
        var url = "{{ route('Contact-List.edit', ':model_id') }}";
...
<script>
    $(document).ready(function() {
        $("#editForm").submit(function(e) {
            ...
            var url = "{{ route('Contact-List.update', ':model_id') }}";
            //
            $.ajax({
                url: url.replace(':model_id', model_id),
                type: 'POST',
    ...
    $("#buttons-datatables").on("click", ".rem-element", function(e) {
        ...
        swal({
            ...
            .then((justTransfer) => {
                if (justTransfer) {
                    var model_id = $(this).attr("data-id");
                    var url = "{{ route('Contact-List.destroy', ':model_id') }}";
